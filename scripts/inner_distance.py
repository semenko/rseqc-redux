...
def main():
    ...
    parser.add_option(
        "-r", "--refgene", action="store", type="string", dest="ref_gene", help="Reference gene model in BED format."
    )
    parser.add_option(
        "-k",
        "--sample-size",
        ...
        dest="sampleSize",
        default=1000000,
        help="Number of read-pairs used to estimate inner distance. default=%default",
    )
    parser.add_option(
        "-l",
        "--lower-bound",
        ...
        default=-250,
        help="Lower bound of inner distance (bp). This option is used for ploting histograme. default=%default",
    )
    parser.add_option(
        "-u",
        "--upper-bound",
        ...
        default=250,
        help="Upper bound of inner distance (bp). This option is used for plotting histogram. default=%default",
    )
    parser.add_option(
        "-s",
        "--step",
        ...
        dest="step_size",
        default=5,
        help="Step size (bp) of histograme. This option is used for plotting histogram. default=%default",
    )
    parser.add_option(
        "-q",
        "--mapq",
