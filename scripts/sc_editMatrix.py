...
def main():
    ...
    parser.add_option(
        ...
        dest="reads_num",
        default=None,
        help="Number of alignments to process. default=%default",
    )
    parser.add_option(
        "--cr-tag",
        action="store",
        ...
        dest="CR_tag",
        default="CR",
        help="Tag of cellular barcode reported by the sequencer in BAM file. default='%default'",
    )
    parser.add_option(
        "--cb-tag",
        action="store",
        ...
        dest="CB_tag",
        default="CB",
        help="Tag of error-corrected cellular barcode in BAM file. default='%default'",
    )
    parser.add_option(
        "--ur-tag",
        action="store",
        ...
        dest="UR_tag",
        default="UR",
        help="Tag of UMI reported by the sequencer in BAM file. default='%default'",
    )
    parser.add_option(
        "--ub-tag",
        action="store",
        ...
        dest="UB_tag",
        default="UB",
        help="Tag of error-corrected UMI in BAM file. default='%default'",
    )
    parser.add_option(
        "--cell-width",
        action="store",
        ...
        dest="cell_width",
        default=15,
        help="Points of cell width in the heatmap. default=%default",
    )
    parser.add_option(
        "--cell-height",
        action="store",
        ...
        dest="cell_height",
        default=10,
        help="Points of cell height in the heatmap. default=%default",
    )
    parser.add_option(
        "--font-size",
        action="store",
        ...
        dest="font_size",
        default=8,
        help="Font size. If --display-num was set, fontsize_number = 0.8 * font_size. default=%default",
    )
    parser.add_option(
        "--angle",
        action="store",
    ...
    scbam.barcode_edits(
        ...
        limit=options.reads_num,
        CR_tag=options.CR_tag,
        CB_tag=options.CB_tag,
        UR_tag=options.UR_tag,
        UB_tag=options.UB_tag,
    )
