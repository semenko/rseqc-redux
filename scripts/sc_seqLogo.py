...
default=%default (no highlight)",
    ...
    fastq.make_logo(
        ...
        exclude_N=options.exclude_N,
        font_name=options.font_name,
        stack_order=options.stack_order,
        flip_below=options.flip_below,
        shade_below=options.shade_below,
        fade_below=options.fade_below,
        highlight_start=options.hi_start,
        highlight_end=options.hi_end,
        oformat=options.out_format,
    )
